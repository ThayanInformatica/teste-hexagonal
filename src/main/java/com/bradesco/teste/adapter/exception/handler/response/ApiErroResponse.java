...
public class ApiErroResponse {
    ...
    private void addValidacaoErro(FieldError fieldError) {
        this.addValidacaoErro(fieldError.getObjectName(), fieldError.getField(), fieldError.getRejectedValue(),
    ...
    private void addValidacaoErro(ObjectError objectError) {
        this.addValidacaoErro(objectError.getObjectName(), objectError.getDefaultMessage());
    }
    ...
    private void addValidacaoErro(ConstraintViolation<?> cv) {
        this.addValidacaoErro(cv.getRootBeanClass().getSimpleName(),
